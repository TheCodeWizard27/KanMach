...
void main()
{
    ...
    vec3 textureColor = texture(sampler2D(DiffuseTexture, DiffuseSampler), fs_in_TexturePos).xyz;
    vec3 objectColor = textureColor * fs_in_Material.Diffuse;
